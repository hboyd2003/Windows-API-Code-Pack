...
public interface IMappingFormatter<T>
{
    ...
    /// <returns>
    ///     The formatted object constructed with the data contained inside the
    ///     <see cref="MappingDataRange">MappingDataRange</see>.
    /// </returns>
    T Format(MappingDataRange dataRange);

    /// <summary>
    ///     Formats all <see cref="MappingDataRange">MappingDataRanges</see> contained inside the
    ...
    /// <returns>
    ///     An array of T objects which represent the data contained inside each
    ///     <see cref="MappingDataRange">MappingDataRange</see> of the

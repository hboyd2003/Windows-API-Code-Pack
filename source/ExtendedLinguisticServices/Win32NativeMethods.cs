...
internal static class Win32NativeMethods
{
    ...
    internal static extern uint MappingGetServices(ref Win32EnumOptions enumOptions, ref IntPtr services,
        ref uint servicesCount);
    ...
    internal static extern uint MappingRecognizeText(IntPtr service, IntPtr text, uint length, uint index,
        IntPtr options, ref Win32PropertyBag bag);
}

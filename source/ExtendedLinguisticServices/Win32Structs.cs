...
internal struct Win32DataRange
{
    ...
    [MarshalAs(UnmanagedType.LPWStr)] internal string _contentType;
...
internal struct Win32EnumOptions
{
    ...
    [MarshalAs(UnmanagedType.LPWStr)] internal string _category;

    [MarshalAs(UnmanagedType.LPWStr)] internal string _inputLanguage;

    [MarshalAs(UnmanagedType.LPWStr)] internal string _outputLanguage;

    [MarshalAs(UnmanagedType.LPWStr)] internal string _inputScript;

    [MarshalAs(UnmanagedType.LPWStr)] internal string _outputScript;

    [MarshalAs(UnmanagedType.LPWStr)] internal string _inputContentType;

    [MarshalAs(UnmanagedType.LPWStr)] internal string _outputContentType;
...
internal struct Win32Service
{
    ...
    [MarshalAs(UnmanagedType.LPWStr)] internal string _copyright;
    ...
    [MarshalAs(UnmanagedType.LPWStr)] internal string _description;

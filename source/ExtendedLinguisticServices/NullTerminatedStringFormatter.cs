...
{
    /// <summary>
    ///     Converts a single <see cref="MappingDataRange">MappingDataRange</see> into a string, stripping the trailing null
    ///     character. If
    ...
    public string Format(MappingDataRange dataRange)
    {
        ...
        if ((data.Length & 1) != 0) throw new LinguisticException(LinguisticException.InvalidArgs);

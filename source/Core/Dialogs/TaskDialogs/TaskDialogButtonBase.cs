...
/// <summary>
///     Defines the abstract base class for task dialog buttons. Classes that inherit from this class will inherit the Text
///     property defined
///     in this class.
/// </summary>
public abstract class TaskDialogButtonBase : TaskDialogControl
{
    ...
    /// <summary>
    ///     Gets or sets a value that determines whether the button is enabled. The enabled state can cannot be changed before
    ///     the dialog is shown.
    /// </summary>
    public bool Enabled
    {

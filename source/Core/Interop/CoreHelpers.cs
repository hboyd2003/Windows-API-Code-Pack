...
public static class CoreHelpers
{
    ...
    {
        if (!RunningOnVista) throw new PlatformNotSupportedException(LocalizedMessages.CoreHelpersRunningOnVista);
    }
    ...
    {
        if (!RunningOnWin7) throw new PlatformNotSupportedException(LocalizedMessages.CoreHelpersRunningOn7);
    }
    ...
    {
        if (!RunningOnXP) throw new PlatformNotSupportedException(LocalizedMessages.CoreHelpersRunningOnXp);
    }
}

...
/// <summary>
///     Provides access to the Application Restart and Recovery features available in Windows Vista or higher. Application
///     Restart and
...
public static class ApplicationRestartRecoveryManager
{
    ...
    /// </summary>
    /// <remarks>
    ///     This should be the last call made by the <see cref="RecoveryCallback" /> method because Windows Error Reporting
    ///     will terminate the
    ...
    /// <summary>
    ///     Called by an application's <see cref="RecoveryCallback" /> method to indicate that it is still performing recovery
    ///     work.
    /// </summary>
    ...
    /// <param name="settings">
    ///     An object that specifies the callback method, an optional parameter to pass to the callback method and a time
    ///     interval.
    /// </param>
    ...
    /// <param name="settings">
    ///     An object that specifies the command line arguments used to restart the application, and the conditions under which
    ///     the

...
{
    private static readonly NetworkListManagerClass manager = new();
    ...
    /// <summary>
    ///     Retrieves a collection of <see cref="NetworkConnection" /> objects that represent the connections for this
    ///     machine.
    /// </summary>
    ...
    /// <param name="level">
    ///     The <see cref="NetworkConnectivityLevels" /> that specify the connectivity level of the returned
    ///     <see cref="Network" /> objects.
    /// </param>

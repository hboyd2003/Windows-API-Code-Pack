...
/// <summary>
///     Represents a network on the local machine. It can also represent a collection of network connections with a similar
///     network signature.
/// </summary>
...
public class Network
{
    ...
    /// <remarks>
    ///     Connectivity provides information on whether the network is connected, and the protocols in use for network
    ///     traffic.
    /// </remarks>

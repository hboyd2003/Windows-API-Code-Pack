...
/// <summary>
///     This class generates .NET events based on Windows messages. The PowerRegWindow class processes the messages
///     from Windows.
/// </summary>
internal static class MessageManager
{
    ...
    internal class PowerRegWindow : Form
    {
        ...
        /// <summary>
        ///     This method is called when a Windows message is sent to this window. The method calls the registered event
        ///     handlers.
        /// </summary>
        protected override void WndProc(ref Message m)
        {
                ...
                (int)m.WParam == PowerManagementNativeMethods.PowerSettingChangeMessage)
            {
                ...
                if (!EventManager.IsMessageCaught(currentEvent)) ExecuteEvents((ArrayList)eventList[currentEvent]);
            }
            else
            {
                base.WndProc(ref m);
        ...
        {
            foreach (EventHandler handler in eventHandlerList) handler.Invoke(null, new EventArgs());
        }
    }
}

...
public enum ExecutionStates
{
    ...
    /// <summary>
    ///     Enables away mode. This value must be specified with ES_CONTINUOUS. Away mode should be used only by
    ///     media-recording and
    ///     media-distribution applications that must perform critical background processing on desktop computers while the
    ///     computer appears

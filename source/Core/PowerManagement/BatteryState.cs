...
public class BatteryState
{
    internal BatteryState()
    {
        ...
        if (!state.BatteryPresent) throw new InvalidOperationException(LocalizedMessages.PowerManagerBatteryNotPresent);
    ...
    /// <remarks>
    ///     If plugged in, fully charged: DischargeRate = 0. If plugged in, charging: DischargeRate = positive mW per hour. If
    ///     unplugged:
    ...
    /// <value>An <see cref="System.Int32" /> value.</value>
    public int SuggestedBatteryWarningCharge { get; }

    /// <summary>
    ///     Gets the manufacturer's suggested battery charge level that should cause a critical alert to be sent to the
    ///     user.
    /// </summary>
    /// <value>An <see cref="System.Int32" /> value.</value>

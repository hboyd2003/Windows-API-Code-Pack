...
public class Sensor : ISensorEvents
{
    ...
    public Guid? CategoryId
    {
        get
        {
            if (categoryId == null)
            {
                ...
                if (hr == HResult.Ok) categoryId = id;
            }
    ...
    public string Description
    {
        get
        {
            if (description == null) description = (string)GetProperty(SensorPropertyKeys.SensorPropertyDescription);
    ...
    public string DevicePath
    {
        get
        {
            if (devicePath == null) devicePath = (string)GetProperty(SensorPropertyKeys.SensorPropertyDeviceId);
    ...
    public string Manufacturer
    {
        get
        {
            if (manufacturer == null) manufacturer = (string)GetProperty(SensorPropertyKeys.SensorPropertyManufacturer);
            return manufacturer;
        }
    }
    ...
    public string Model
    {
        get
        {
            if (model == null) model = (string)GetProperty(SensorPropertyKeys.SensorPropertyModel);
            return model;
        }
    }
    ...
    public uint ReportInterval
    {
        ...
        set => SetProperties(new DataFieldInfo[]
            { new(SensorPropertyKeys.SensorPropertyCurrentReportInterval, value) });
    }
    ...
    public string SerialNumber
    {
        get
        {
            if (serialNumber == null) serialNumber = (string)GetProperty(SensorPropertyKeys.SensorPropertySerialNumber);
            return serialNumber;
        }
    }
    ...
    void ISensorEvents.OnDataUpdated(ISensor sensor, ISensorDataReport newData)
    {
        ...
        if (DataReportChanged != null) DataReportChanged.Invoke(this, EventArgs.Empty);
    }
    ...
    {
        if (StateChanged != null) StateChanged.Invoke(this, EventArgs.Empty);
    }
    ...
    /// <summary>
    ///     Retrieves the values of multiple properties by their index. Assumes that the GUID component of the property keys is
    ///     the sensor's
    ///     type GUID.
    /// </summary>
    ...
    {
        if (propIndexes == null || propIndexes.Length == 0) throw new ArgumentNullException("propIndexes");
    ...
    /// <summary>
    ///     Retrieves a property value by the property index. Assumes the GUID component in the property key takes the sensor's
    ///     type GUID.
    /// </summary>
    ...
    {
        if (nativeISensor == null) throw new SensorPlatformException(LocalizedMessages.SensorNotInitialized);
    ...
    {
        if (data == null || data.Length == 0) throw new ArgumentException(LocalizedMessages.SensorEmptyData, "data");
    ...
    /// <summary>
    ///     Initializes the Sensor wrapper after it has been bound to the native ISensor interface and is ready for subsequent
    ///     initialization.
    /// </summary>
    ...
    protected void SetEventInterest(Guid eventType)
    {
        ...
        if (hr != HResult.Ok) throw Marshal.GetExceptionForHR((int)hr);
    }

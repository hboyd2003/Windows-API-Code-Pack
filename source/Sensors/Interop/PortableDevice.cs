...
/// <summary>
///     Holds a collection of PROPERTYKEY values. This interface can be retrieved from a method or, if a new object is
///     required, call
...
/// <summary>
///     Holds a collection of PropVariant values of the same VARTYPE. The VARTYPE of the first item that is added to the
///     collection
///     determines the VARTYPE of the collection. An attempt to add an item of a different VARTYPE may fail if the
///     PropVariant value cannot
...
/// <summary>
///     The nativeIPortableDeviceValues interface holds a collection of PROPERTYKEY/PropVariant pairs. Values in the
///     collection do not need
///     to be all the same VARTYPE. Values are stored as key-value pairs; each key must be unique in the collection.
///     Clients can search for
///     items by PROPERTYKEY or zero-based index. Data values are stored as PropVariant structures. You can add or retrieve
///     values of any
///     type by using the generic methods SetValue and GetValue, or you add items by using the method specific to the type
///     of data added.
/// </summary>
[ComImport]
...
internal interface IPortableDeviceValues
{
    ...
    void SetnativeIPortableDeviceValuesValue([In] ref PropertyKey key,
        [In] [MarshalAs(UnmanagedType.Interface)] IPortableDeviceValues pValue);

    void GetnativeIPortableDeviceValuesValue([In] ref PropertyKey key,
    ...
    void SetnativeIPortableDeviceValuesCollectionValue([In] ref PropertyKey key,
        [In] [MarshalAs(UnmanagedType.Interface)] IPortableDeviceValuesCollection pValue);

    void GetnativeIPortableDeviceValuesCollectionValue([In] ref PropertyKey key,
...
/// <summary>
///     Holds a collection of indexed nativeIPortableDeviceValues interfaces. This interface can be retrieved from a
///     method, or if a new
...
internal interface IPortableDeviceValuesCollection
{
    ...
    /// <param name="pcElems">
    ///     Pointer to a DWORD that contains the number of nativeIPortableDeviceValues interfaces in the
    ///     collection.
    /// </param>
    void GetCount([In] ref uint pcElems);
    ...
    /// <param name="ppValues">
    ///     Address of a variable that receives a pointer to an nativeIPortableDeviceValues interface from the collection. The
    ///     caller is
    ...
    /// <param name="pValues">
    ///     Pointer to an nativeIPortableDeviceValues interface to add to the collection. The interface is not actually copied,
    ///     but AddRef is
    ///     called on it
    /// </param>
...
internal class PortableDeviceValues : IPortableDeviceValues
{
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void SetnativeIPortableDeviceValuesValue([In] ref PropertyKey key,
        [In] [MarshalAs(UnmanagedType.Interface)] IPortableDeviceValues pValue);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void GetnativeIPortableDeviceValuesValue([In] ref PropertyKey key,
        [MarshalAs(UnmanagedType.Interface)] out IPortableDeviceValues ppValue);
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void SetnativeIPortableDeviceValuesCollectionValue([In] ref PropertyKey key,
        [In] [MarshalAs(UnmanagedType.Interface)] IPortableDeviceValuesCollection pValue);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void GetnativeIPortableDeviceValuesCollectionValue([In] ref PropertyKey key,
        [MarshalAs(UnmanagedType.Interface)] out IPortableDeviceValuesCollection ppValue);

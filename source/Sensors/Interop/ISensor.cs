...
internal interface ISensor
{
    ...
    HResult GetProperties(
        ...
        out IPortableDeviceValues properties);

    /// <summary>
    ///     Get the array of SensorDataField objects that describe the individual values that can be reported by the
    ///     sensor
    /// </summary>
    ...
    HResult GetSupportedDataFields(
        [Out] [MarshalAs(UnmanagedType.Interface)]
        out IPortableDeviceKeyCollection dataFields);
    ...
    void SupportsDataField(
        [In] PropertyKey key,
        [Out] [MarshalAs(UnmanagedType.VariantBool)]
    ...
    [PreserveSig]
    HResult SetEventInterest([In] [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Guid[] pValues,
        [In] uint count);

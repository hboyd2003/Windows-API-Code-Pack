...
internal interface NativeISensorManager
{
    ...
    /// <param name="sensors">
    ///     Pointer to the ISensorCollection interface that contains the list of sensors for which permission is being
    ///     requested
    /// </param>
...
[ComImport]
[GuidAttribute("77A1C827-FCD2-4689-8915-9D613CC5FA3E")]

...
/// <summary>
///     This is the base class for all WPF-based preview handlers and provides their basic functionality. To create a
///     custom preview handler
///     that contains a WPF user control, a class must derive from this, use the <see cref="PreviewHandlerAttribute" />,
///     and implement 1 or
///     more of the following interfaces: <see cref="IPreviewFromStream" />, <see cref="IPreviewFromShellObject" />,
...
public abstract class WpfPreviewHandler : PreviewHandler, IDisposable
{
    ...
    protected override IntPtr Handle
    {
        ...
        {
            {
                if (_source == null) throw new InvalidOperationException(LocalizedMessages.WpfPreviewHandlerNoHandle);
    ...
    /// <summary>
    ///     Provides means to dispose the object. When overriden, it is imperative that base.Dispose(true) is called within the
    ///     implementation.
    /// </summary>
    /// <param name="disposing"></param>
    protected virtual void Dispose(bool disposing)
    {
        if (disposing && _source != null) _source.Dispose();
    }
    ...
    protected override void SetFont(LogFont font)
    {
        ...
        Control.FontWeight = font.Weight > 0 && font.Weight < 1000
            ? FontWeight.FromOpenTypeWeight(font.Weight)
            : FontWeights.Normal;
    }
    ...
    {
        if (Control == null) throw new InvalidOperationException(LocalizedMessages.PreviewHandlerControlNotInitialized);
    }
    ...
    protected void UpdatePlacement()
    {
        if (_source != null)
        {
            ...
            Interop.HandlerNativeMethods.SetWindowPos(_source.Handle, new IntPtr((int)SetWindowPositionInsertAfter.Top),
                0, 0, Math.Abs(_bounds.Left - _bounds.Right), Math.Abs(_bounds.Top - _bounds.Bottom),

...
public interface IThumbnailFromFile
{
    ...
    ///     <remarks>
    ///         Only 32bpp bitmaps support
    ///         adornments. While 24bpp bitmaps will be displayed they will not display adornments. Additional guidelines for
    ///         developing
    ///         thumbnails can be found at http://msdn.microsoft.com/en-us/library/cc144115(v=VS.85).aspx
    ///     </remarks>
    /// </summary>

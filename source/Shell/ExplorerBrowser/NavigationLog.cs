...
public class ExplorerBrowserNavigationLog
{
    ...
    {
        if (parent == null) throw new ArgumentException(LocalizedMessages.NavigationLogNullParent, "parent");
    ...
    /// <summary>
    ///     An index into the Locations collection. The ShellObject pointed to by this index is the current location of the
    ///     ExplorerBrowser.
    /// </summary>
    ...
    public IEnumerable<ShellObject> Locations
    {
        get
        {
            foreach (var obj in _locations) yield return obj;
        }
    }
    ...
    public void ClearLog()
    {
        ...
        if (NavigationLogChanged != null) NavigationLogChanged(this, args);
    }
    ...
    private void OnNavigationComplete(object sender, NavigationCompleteEventArgs args)
    {
        ...
        if (NavigationLogChanged != null) NavigationLogChanged(this, eventArgs);
    }

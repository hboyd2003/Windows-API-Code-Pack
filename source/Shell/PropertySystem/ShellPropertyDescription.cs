...
public class ShellPropertyDescription : IDisposable
{
    ...
    /// <summary>
    ///     Gets a value that describes how the property values are displayed when multiple items are selected in the user
    ///     interface (UI).
    /// </summary>
    public PropertyAggregationType AggregationTypes
    {
        get
        {
            if (NativePropertyDescription != null && aggregationTypes == null)
            {
                ...
                if (CoreErrorHelper.Succeeded(hr)) aggregationTypes = tempAggregationTypes;
            }

            return aggregationTypes.HasValue ? aggregationTypes.Value : default;
        }
    }
    ...
    /// <summary>
    ///     Gets the column state flag, which describes how the property should be treated by interfaces or APIs that use this
    ///     flag.
    /// </summary>
    public PropertyColumnStateOptions ColumnState
    {
        get
        {
            ...
            if (NativePropertyDescription != null && columnState == null)
            {
                ...
                if (CoreErrorHelper.Succeeded(hr)) columnState = state;
            }
    ...
    ///     This
    ///     influences the list of predicate conditions (for example, equals, less than, and contains) that are shown for this
    ///     property.
    /// </summary>
    /// <remarks>
    ///     For more information, see the <c>conditionType</c> attribute of the <c>typeInfo</c> element in the property's
    ///     .propdesc file.
    /// </remarks>
    public PropertyConditionOperation ConditionOperation
    {
        get
        {
            ...
            {
                var hr = NativePropertyDescription.GetConditionType(out var tempConditionType,
                    out var tempConditionOperation);
    ...
    /// <summary>
    ///     Gets the condition type to use when displaying the property in the query builder user interface (UI). This
    ...
    public uint DefaultColumWidth
    {
        get
        {
            if (NativePropertyDescription != null && !defaultColumWidth.HasValue)
            {
                ...
                if (CoreErrorHelper.Succeeded(hr)) defaultColumWidth = tempDefaultColumWidth;
            }
    ...
    public PropertyDisplayType DisplayType
    {
        get
        {
            if (NativePropertyDescription != null && displayType == null)
            {
                ...
                if (CoreErrorHelper.Succeeded(hr)) displayType = tempDisplayType;
            }
    ...
    /// <remarks>
    ///     The information retrieved by this method comes from the <c>groupingRange</c> attribute of the <c>typeInfo</c>
    ///     element in the
    ...
    public PropertyGroupingRange GroupingRange
    {
        get
        {
            ...
            if (NativePropertyDescription != null && groupingRange == null)
            {
                ...
                if (CoreErrorHelper.Succeeded(hr)) groupingRange = tempGroupingRange;
            }
    ...
    /// </summary>
    /// <remarks>
    ///     The settings retrieved by this method are set through the <c>sortDescription</c> attribute of the <c>labelInfo</c>
    ///     element in the
    ///     property's .propdesc file.
    /// </remarks>
    public PropertySortDescription SortDescription
    {
        get
        {
            ...
            if (NativePropertyDescription != null && sortDescription == null)
            {
                ...
                if (CoreErrorHelper.Succeeded(hr)) sortDescription = tempSortDescription;
            }
    ...
    public Type ValueType
    {
        get
        {
            if (valueType == null) valueType = ShellPropertyFactory.VarEnumToSystemType(VarEnumType);
    ...
    public VarEnum VarEnumType
    {
        get
        {
            if (NativePropertyDescription != null && varEnumType == null)
            {
                ...
                if (CoreErrorHelper.Succeeded(hr)) varEnumType = tempType;
            }
    ...
    internal IPropertyDescription NativePropertyDescription
    {
        get
        {
            if (nativePropertyDescription == null)
            {
                ...
                PropertySystemNativeMethods.PSGetPropertyDescription(ref propertyKey, ref guid,
    ...
    ///     Indicates the sort order should reference the string "Z on top"; otherwise, the sort order should reference the
    ///     string "A on top".
    /// </param>
    /// <returns>The sort description for this property.</returns>
    /// <remarks>
    ///     The string retrieved by this method is determined by flags set in the <c>sortDescription</c> attribute of the
    ///     <c>labelInfo</c>

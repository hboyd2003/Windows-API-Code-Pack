...
public interface IShellProperty
{
    ...
    /// <summary>
    ///     Gets the image reference path and icon index associated with a property value. This API is only available in
    ///     Windows 7.
    /// </summary>
    ...
    /// <remarks>
    ///     To obtain a specific type for this value, use the more strongly-typed <c>Property&lt;T&gt;</c> class. You can only
    ///     set a value

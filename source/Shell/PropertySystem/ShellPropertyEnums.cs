...
public enum PropertyAggregationType
{
    ...
    /// <summary>
    ///     The sum of the selected values is displayed. This flag is never returned for data types VT_LPWSTR, VT_BOOL, and
    ///     VT_FILETIME.
    /// </summary>
    Sum = 2,

    /// <summary>
    ///     The numerical average of the selected values is displayed. This flag is never returned for data types VT_LPWSTR,
    ///     VT_BOOL, and VT_FILETIME.
    /// </summary>
    Average = 3,

    /// <summary>
    ///     The date range of the selected values is displayed. This flag is only returned for values of the VT_FILETIME data
    ///     type.
    /// </summary>
    DateRange = 4,

    /// <summary>
    ///     A concatenated string of all the values is displayed. The order of individual values in the string is undefined.
    ///     The concatenated
    ///     string omits duplicate values; if a value occurs more than once, it only appears a single time in the concatenated
    ///     string.
    /// </summary>
    Union = 5,
...
/// <summary>
///     Provides a set of flags to be used with IConditionFactory, ICondition, and IConditionGenerator to indicate the
///     operation.
/// </summary>
...
/// <remarks>
///     Typically use one, or a bitwise combination of these flags, to specify the format. Some flags are mutually
///     exclusive, so combinations
...
public enum PropertyDescriptionFormatOptions
{
    ...
    /// <remarks>
    ///     This flag is ignored when the <c>hideLabelPrefix</c> attribute of the <c>labelInfo</c> element in the property's
    ///     .propinfo file
    ///     is set to true.
    /// </remarks>
    PrefixName = 0x1,
    ...
    /// <remarks>
    ///     The invitation text is returned if formatting failed or the value was empty. Invitation text is text displayed in a
    ///     text box as a
    ///     cue for the user, Formatting can fail if the data entered is not of an expected type, such as putting alpha
    ///     characters in a phone
    ///     number field.
    /// </remarks>
    UseEditInvitation = 0x800,

    /// <summary>
    ///     This flag requires UseEditInvitation to also be specified. When the formatting flags are ReadOnly |
    ///     UseEditInvitation and the
    ///     algorithm would have shown invitation text, a string is returned that indicates the value is "Unknown" instead of
    ///     the invitation text.
    /// </summary>
    ReadOnly = 0x1000,

    /// <summary>
    ///     The detection of the reading order is not automatic. Useful when converting to ANSI to omit the Unicode reading
    ///     order characters.
    /// </summary>
...
public enum PropertyTypeOptions
{
    ...
    /// <remarks>
    ///     These values are stored as a VT_VECTOR in the PROPVARIANT structure. This value is set by the multipleValues
    ///     attribute of the
    ...
    /// <remarks>
    ///     This value is set by the includeInFullTextQuery attribute of the typeInfo element in the property's .propdesc
    ///     file.
    /// </remarks>
    ...
    /// <remarks>
    ///     This influences whether the property shows up in the "Choose Columns" dialog, for example. This value is set by the
    ///     isViewable
    ...
    /// <remarks>
    ///     A queryable property must also be viewable. This influences whether the property shows up in the query builder UI.
    ///     This value is

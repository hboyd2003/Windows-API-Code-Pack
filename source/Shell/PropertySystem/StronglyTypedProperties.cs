...
public partial class ShellProperties
{
    ...
    public class PropertySystem : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: The list of type of items, this item contains. For example, this item contains urls, attachments
        ///         etc.
        ...
        ///     <para>
        ///         Description: The time the file entered the system via acquisition.  This is not the same as
        ///         System.DateImported.
        ...
        ///     <para>
        ///         Description: The time the file is imported into a separate database.  This is not the same as
        ...
        ///     <para>
        ///         Description: The CLSID of the name space extension for an item, the object that implements IShellFolder for
        ///         this item
        ///     </para>
        ...
        ///     <para>
        ///         Description: What is the item's sharing status (not shared, shared, everyone (homegroup or everyone), or
        ///         private)?
        ///     </para>
        ///     <para>Type:     UInt32 -- VT_UI4</para>
        ...
        ///     <para>
        ///         Description: Unique value that can be used as a key to cache thumbnails. The value changes when the name,
        ///         volume, or data modified
        ///         of an item changes.
        ///     </para>
        ///     <para>Type:     UInt64 -- VT_UI8</para>
    ...
    public class PropertySystemDevices : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: Remaining battery life of the device as an integer between 0 and 100 percent and the device's
        ///         charging state.
        ///     </para>
        ///     <para>Type:     Byte -- VT_UI1</para>
        ...
        ///     <para>
        ///         Description: Device connection state. If VARIANT_TRUE, indicates the device is currently connected to the
        ///         computer.
        ///     </para>
        ///     <para>Type:     Boolean -- VT_BOOL</para>
    ...
    public class PropertySystemGPS : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: Indicates the distance to the destination point.  Calculated from PKEY_GPS_DestDistanceNumerator
        ///         and
        ...
        ///     <para>
        ///         Description: Indicates the unit used to express the distance to the destination.  (eg: kilometers, miles,
        ///         knots)
        ///     </para>
        ///     <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        ///     <para>
        ///         Description: Indicates the latitude of the destination point.  This is an array of three values.  Index 0 is
        ///         the degrees, index 1
        ///         is the minutes, index 2 is the seconds.  Each is calculated from the values in PKEY_GPS_DestLatitudeNumerator
        ///         and
        ...
        ///         Description: Indicates the latitude of the destination point.  This is an array of three values.  Index 0 is
        ///         the degrees, index 1
        ///         is the minutes, index 2 is the seconds.  Each is calculated from the values in PKEY_GPS_DestLongitudeNumerator
        ///         and
        ...
        ///     <para>
        ///         Description: Indicates direction of the image when it was captured.  Calculated from
        ...
        ///     <para>
        ///         Description: Indicates reference for giving the direction of the image when it was captured.  (eg: true
        ///         direction, magnetic direction)
        ///     </para>
        ///     <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
        ...
        ///         minutes, index 2
        ///         is the seconds.  Each is calculated from the values in PKEY_GPS_LatitudeNumerator and
        ...
        ///     <para>
        ///         Description: Indicates the longitude.  This is an array of three values.  Index 0 is the degrees, index 1 is
        ///         the minutes, index 2
        ...
        ///     <para>
        ///         Description: Indicates the unit used to express the speed of the GPS receiver movement.  (eg: kilometers per
        ///         hour,
        ...
        ///     <para>
        ///         Description: Indicates the status of the GPS receiver when the image was recorded.  (eg: measurement in
        ///         progress,
    ...
    public class PropertySystemLayoutPattern : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: Specifies the layout pattern that the content view mode should apply for this item in the context
        ///         of browsing.
    ...
    public class PropertySystemMessage : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: Flags associated with a message flagged to know if it's still active, if it was custom flagged,
        ///         etc.
        ///     </para>
        ///     <para>Type:     Int32 -- VT_I4</para>
    ...
    public class PropertySystemPhoto : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: PropertyTagExifFNumber.  Calculated from PKEY_Photo_FNumberNumerator and
        ...
        ///     <para>
        ///         Description: This is the user-friendly form of System.Photo.PhotometricInterpretation.  Not intended to be
        ///         parsed
        ///         programmatically.
        ///     </para>
        ///     <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
    ...
    public class PropertySystemPropList : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: The list of properties to show in the file operation conflict resolution dialog. Properties with
        ///         empty
        ...
        ///     <para>
        ///         Description: The list of properties to show in the file operation confirmation dialog. Properties with empty
        ///         values
        ...
        ///     <para>
        ///         Description: The list of all the properties to show in the details page.  Property groups can be included in
        ///         this list
        ...
        ///     <para>
        ///         Description: The one or two properties to display in the preview pane title section.  The optional second
        ///         property is
        ...
        ///     <para>
        ///         Description: The list of properties to show in the listview on tiles. Register under the regvalue of
        ///         "TileInfo".
        ///     </para>
        ///     <para>Type:     String -- VT_LPWSTR  (For variants: VT_BSTR)</para>
    ...
    public class PropertySystemSearch : PropertyStoreItems
    {
        ...
        ///     <para>
        ///         Description: The contents of the item. This property is for query restrictions only; it cannot be retrieved in
        ///         a
        ...
        ///     <para>
        ///         Description: The Datetime that the Windows Search Gatherer process last pushed properties of this document to
        ...
        ///         hasn't been visited (which is the normal mechanism for detecting deletes).  For example an email attachment
        ///         would emit this property
        ///     </para>
        ///     <para>Type:     Boolean -- VT_BOOL</para>
        ...
        ///     <para>
        ///         Description: This property should be emitted by a container IFilter for each child URL within the container.
        ...
        ///         last modified.  This is an optimization for the indexer as it doesn't have to call back into the protocol
        ///         handler to ask for this information to determine if the content needs to be indexed again.  The property is a
        ///         vector with two elements, a VT_LPWSTR with the URL and a VT_FILETIME for the last modified time.
        ///     </para>

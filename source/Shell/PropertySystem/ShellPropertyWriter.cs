...
public class ShellPropertyWriter : IDisposable
{
    ...
    /// <summary>
    ///     Writes the given property key and value. To allow truncation of the given value, set allowTruncatedValue to
    ///     true.
    /// </summary>
    /// <param name="key">The property key.</param>
    /// <param name="value">The value associated with the key.</param>
    ...
    ///     If AllowTruncatedValue is set to false and while setting the value on the property it had to be truncated in a
    ///     string or rounded
    ///     in a numeric value.
    /// </exception>
    ...
    /// <summary>
    ///     Writes the specified property given a strongly-typed ShellProperty and a value. To allow truncation of the given
    ///     value, set
    ///     allowTruncatedValue to true.
    /// </summary>
    /// <typeparam name="T">The type of the property name.</typeparam>

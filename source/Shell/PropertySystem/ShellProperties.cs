...
/// <summary>
///     Defines a partial class that implements helper methods for retrieving Shell properties using a canonical name,
///     property key, or a
///     strongly-typed property. Also provides access to all the strongly-typed system properties and default properties
///     collections.
/// </summary>
public partial class ShellProperties : IDisposable
{
    ...
    public PropertySystem System
    {
        get
        {
            if (propertySystem == null) propertySystem = new PropertySystem(ParentShellObject);
    ...
    /// <remarks>
    ///     Use the Using pattern with the returned ShellPropertyWriter or manually call the Close method on the writer to
    ///     commit the changes
    ...
    {
        if (disposed && defaultPropertyCollection != null) defaultPropertyCollection.Dispose();
    }
}

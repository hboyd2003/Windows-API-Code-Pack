...
/// <summary>
///     Defines a strongly-typed property object. All writable property objects must be of this type to be able to call the
///     value setter.
/// </summary>
/// <typeparam name="T">
///     The type of this property's value. Because a property value can be empty, only nullable types are
///     allowed.
/// </typeparam>
public class ShellProperty<T> : IShellProperty
{
    ...
    /// <remarks>
    ///     An <see cref="ArgumentOutOfRangeException" /> will be thrown if this property is not set to true, and a property
    ///     value was set but
    ///     later truncated.
    /// </remarks>
    ...
    /// <summary>
    ///     Gets or sets the strongly-typed value of this property. The value of the property is cleared if the value is set to
    ///     null.
    /// </summary>
    ...
    ///     Thrown if <see cref="AllowSetTruncatedValue" /> is false, and either a string value was truncated or a numeric
    ///     value was rounded.
    /// </exception>
    public T Value
    {
    ...
    /// <summary>
    ///     Gets the value for this property using the generic Object type. To obtain a specific type for this value, use the
    ///     more type
    ...
    ///     The formatted value as a string, or null if this property cannot be formatted for
    ///     display.
    /// </param>
    ...
    private void StorePropVariantValue(PropVariant propVar)
    {
        ...
        try
        {
            ...
            if (!CoreErrorHelper.Succeeded(result))
                throw new PropertySystemException(LocalizedMessages.ShellPropertySetValue,
